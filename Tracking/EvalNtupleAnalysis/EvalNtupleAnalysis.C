...
EvalNtupleAnalysis::EvalNtupleAnalysis() :
	...
	ntp_track(0),
	ntp_gtrack(0),
	h_nevt_pileup(0), h_nevt_pileup_maps(0),h_den(0), h_num(0),
...
//	float vtxing_eff[npoints];
//	float vtxing_eff_err[npoints];
//	float den[npoints];
//	float num[npoints];
//	float npileup[npoints];
//	float zero[npoints];
...
//	teff_vtxing_eff_npileup = new TEfficiency(*h_num,*h_den);
//	tg_vtxing_eff_npileup = new TGraphErrors(npoints, );
...
//    teff->GetXaxis()->SetTitle("number of pile-up events");
    teff->Draw("q");
